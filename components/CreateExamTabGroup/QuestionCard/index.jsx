...
const QuestionCard = ({
  ...
  return viewMode === "grid" ? (
    // Grid View Card
    <div className="relative flex flex-col p-6 rounded-[10px] border border-gray-100 bg-white shadow-createBox">
      {showActions && (
      ...
      >
        <a className="flex items-center w-full">
          ...
          <div className="flex items-center w-full justify-between">
            ...
            <div className="relative group">
              <div className="text-3.5 font-gilroy mt-1.5 text-arrowButtonGray font-medium truncate cursor-pointer max-w-[30ch] mx-auto">
                {file.sub_folder && file.sub_folder.length > 0
                  ? file.sub_folder.join(" ~ ")
                  : "Hazırda fayl yoxdur"}
              </div>
