...
function CreateSubFolderOrQuestion({
  closeModal,
  addNewSubFolder,
  hasSubFolders,
  hasQuestions, // Receive hasQuestions prop
}) {
        ...
        >
          <div className="bg-white rounded-xl w-full max-w-md p-10 relative">
            ...
            <div className="flex gap-3 mb-6 justify-center">
              {!hasQuestions && ( // Only render if no questions exist
                <label className="flex flex-col items-center justify-center cursor-pointer border border-buttonSecondaryDisabled py-3 px-4 rounded-lg w-40">
...
export default CreateSubFolderOrQuestion;
