...
import { BsTrash3, BsGrid } from "react-icons/bs";
...
function SubExamsListNavigationTeacher({
  viewMode,
  setViewMode,
  sortOption,
  setSortOption,
  ...
  return (
    <div className="flex justify-between relative font-gilroy items-center">
      ...
      {selectedExams.length > 0 ? (
        ...
        <div className="flex flex-row gap-4">
          <button
            ...
            className="flex items-center justify-center gap-2 py-3 px-4 h-11 text-white leading-6 rounded-md bg-errorButtonDefault hover:bg-errorButtonHover active:bg-errorButtonPressed"
          >
        ...
        <div className="flex flex-row gap-4 items-center">
          ...
          <div className="flex flex-row items-center justify-center gap-2 relative">
            ...
            {isSortMenuOpen && (
              <div className="py-2 px-4 absolute top-full mt-1 right-0 bg-white border border-gray-200 rounded-xl shadow-md z-10">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 px-4 py-2 h-11 text-white leading-6 rounded-md bg-buttonPrimaryDefault hover:bg-buttonPrimaryHover active:bg-buttonPressedPrimary"
          >
...
export default SubExamsListNavigationTeacher;
