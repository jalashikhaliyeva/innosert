...
function AddExamFolderModal({ closeModal, addNewFolder }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://innocert-admin.markup.az/api/exam-folder/create/",
        { name: folderName },
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="bg-boxGrayBodyColor z-50 p-10 flex flex-col gap-7 justify-center rounded-lg shadow-lg relative min-w-[300px] md:min-w-[400px]">
        <button
...
export default AddExamFolderModal;
