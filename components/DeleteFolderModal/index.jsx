...
function DeleteFolderModal({ closeModal, onDelete, onCancel }) {
  const handleBackgroundClick = (e) => {
    // Check if the user clicked outside the modal (by comparing the target and currentTarget)
    if (e.target === e.currentTarget) {
      closeModal(); // Trigger the cancel action if clicked outside
    }
  };
  return (
    <div
    ...
    >
      <div className="bg-white rounded-xl shadow-lg p-6 w-96 ">
        ...
        <p
          ...
          style={{ fontFamily: "Gilroy" }}
        >
          Bu qovluğu silmək istədiyinizə əminsinizmi? <br></br> Bu əməliyyat
          geri alına bilməz.
        </p>
