...
function QuestionsNavigationCompany({
  sortOption,
  setSortOption,
  selectedFiles,
  openDeleteModal,
        ...
        <div className="flex flex-row gap-4">
          <div className="flex items-center bg-bodyColor border border-inputBorder rounded-lg px-3 py-2 focus-within:border-inputRingFocus overflow-hidden z-10 hover:bg-inputBgHover">
            ...
            <input
              type="text"
              placeholder="Axtar"
              className="ml-2 w-full text-inputRingFocus bg-bodyColor outline-none placeholder-inputPlaceholderText hover:bg-"
              value={searchTerm}
...
export default QuestionsNavigationCompany;
