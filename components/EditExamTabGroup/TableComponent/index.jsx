...
function TableComponent({ handleDelete, handleEdit, file }) {
  const levelColors = {
    Hard: "bg-redLow",
    Medium: "bg-violetLow",
    Easy: "bg-orangeLow",
  ...
  return (
    <>
      <div className="w-full p-4 font-gilroy border border-borderTableCel rounded bg-white">
        {/* Table */}
        <h3 className="text-xl font-medium mb-4">Table for {file.name}</h3>
        <div className="w-full  overflow-x-auto overflow-y-auto max-h-[380px] flex flex-col relative">
                ...
                >
                  ...
                  {openFilter === "xal" && (
                    <div
                      ...
                      className="absolute z-20 mt-2 bg-white  border rounded shadow p-2 w-60 -ml-20"
                      onClick={(e) => e.stopPropagation()} // Prevent click from closing the dropdown
                    >
                ...
                >
                  ...
                  {openFilter === "vaxt" && (
                    <div
                      ...
                      className="absolute z-20 mt-2 bg-white border rounded shadow p-2 w-60 -ml-40"
                      onClick={(e) => e.stopPropagation()} // Prevent click from closing the dropdown
                    >
                      <div className="flex items-center space-x-2">
                        <input
