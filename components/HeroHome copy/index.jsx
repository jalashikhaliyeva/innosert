  ...
  return (
    <div
      ...
      style={{
        ...
        marginTop: "80px",
        transition: "background-image 0.5s ease-in-out", // Optional if you want to try fading the background
      }}
    >
      <Container>
        <div
          style={{ height: "461px", opacity: fade ? 1 : 0, transition: "opacity 0.5s ease-in-out" }}
